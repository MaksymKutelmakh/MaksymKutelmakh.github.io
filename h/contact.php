...
$header .= "From: Новая заявка <maksymkutelmah@gmail.com>\n\n";	
$mail = mail("maksymkutelmah@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
